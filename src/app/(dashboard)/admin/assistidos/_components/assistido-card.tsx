      ...
      <div className="p-3.5 space-y-2.5 relative z-10">
        ...
        <div className="flex gap-3 items-start">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 mt-1 flex-wrap">
              <span className={cn(
                ...
                !isPreso && !isMonitorado && "bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400",
              )}>
          ...
          <div className="flex items-center gap-0.5 shrink-0">
            {assistido.driveFolderId ? (
              ...
              <div className="h-6 w-6 rounded-md flex items-center justify-center text-neutral-300 dark:text-neutral-600">
            ...
            <button
              ...
              className={cn(
                ...
                isPinned
                  ...
                  : "text-neutral-300 hover:text-amber-500 hover:bg-amber-50 dark:hover:bg-amber-900/20",
              )}
            >
        ...
        {atribuicoesUnicas.length > 0 && (
          <div className="flex items-center gap-1.5 flex-wrap">
            {atribuicoesUnicas.slice(0, 3).map((attr, idx) => {
              ...
              return (
                <span key={idx} className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-medium bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400">
        ...
        <div className="flex items-center gap-3 text-xs">
          ...
          >
            ...
            <span className="font-semibold text-neutral-700 dark:text-neutral-300">{assistido.processosAtivos || 0}</span>
        ...
        {assistido.proximaAudiencia && (
          <div className={cn(
            ...
            <div className="flex items-center gap-1.5 flex-1 min-w-0">
              ...
              <span className="text-[10px] text-neutral-400 font-mono">{format(parseISO(assistido.proximaAudiencia), "HH:mm")}</span>
        ...
        {assistido.crimePrincipal && (
          <p className="text-[10px] text-neutral-400 dark:text-neutral-500 line-clamp-1 italic">
            {assistido.crimePrincipal}
          </p>
        )}
        ...
        {assistido.numeroProcesso && (
          <div className="flex items-center gap-1.5 cursor-pointer group/copy" onClick={handleCopyProcesso}>
            ...
            <span className="font-mono tabular-nums text-[10px] text-neutral-400 truncate flex-1">{assistido.numeroProcesso}</span>
            {copied ? <CheckCircle2 className="w-3 h-3 text-emerald-500" /> : <Copy className="w-3 h-3 text-neutral-300 group-hover/copy:text-neutral-400 transition-colors" />}
          </div>
        )}
      </div>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="h-7 w-7 rounded-lg flex items-center justify-center text-neutral-400 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-all cursor-pointer"
                  >
