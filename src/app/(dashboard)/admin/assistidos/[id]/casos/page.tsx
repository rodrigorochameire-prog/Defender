...
function CriarCasoButton({
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1 h-11 px-3 sm:h-6 sm:px-2 rounded-md text-[10px] font-medium bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-950/50 transition-colors cursor-pointer shrink-0 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/40"
    >
