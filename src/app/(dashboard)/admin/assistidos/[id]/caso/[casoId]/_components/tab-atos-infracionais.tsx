...
export function TabAtosInfracionais({ casoId }: Props) {
  ...
  return (
    <div className="p-4 space-y-3">
      <h3 className="text-base font-semibold">Atos Infracionais (ECA)</h3>
      <p className="text-sm text-neutral-500">
        Processo referência: <strong>#{procRef.id}</strong> ({procRef.area}).
      </p>
      <p className="text-xs italic text-neutral-400">
        Edição de atos infracionais vive na vista técnica do processo.
      </p>
      <a
