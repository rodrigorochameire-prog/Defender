  ...
  if (!template && !isLoading) {
    return (
      <div className="text-center py-12">
        <p className="text-sm text-zinc-500">Template nao encontrado.</p>
        <Button
          variant="link"
  ...
  return (
    <div className="space-y-6">
      ...
      {(template?.totalUsos ?? 0) > 0 && (
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700/30 w-fit">
