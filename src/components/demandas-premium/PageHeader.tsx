      ...
      <div className="relative flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 sm:gap-4 min-w-0">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-zinc-900 dark:bg-white flex items-center justify-center shadow-lg ring-4 ring-zinc-900/5 dark:ring-white/10 shrink-0">
            <Icon className="w-5 h-5 sm:w-5.5 sm:h-5.5 text-white dark:text-zinc-900" />
          </div>
          <div className="min-w-0">
            <h1 className="font-serif text-2xl sm:text-3xl font-semibold text-zinc-900 dark:text-zinc-50 tracking-tight truncate">{title}</h1>
            <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-0.5 truncate">{subtitle}</p>
          </div>
        </div>
