...
export function AdminConfigModal({ isOpen, onClose }: AdminConfigModalProps) {
  ...
  const [statusList, setStatusList] = useState<StatusConfig[]>([
    // Triagem
    { value: "triagem", label: "Triagem", group: "triagem", color: "#8A8A94" },
    { value: "urgente", label: "Urgente", group: "triagem", color: "#D4A4A4" },
    // Preparação
    { value: "elaborar", label: "Elaborar", group: "preparacao", color: "#D4A84A" },
    { value: "elaborando", label: "Elaborando", group: "preparacao", color: "#D4A84A" },
    { value: "analisar", label: "Analisar", group: "preparacao", color: "#D4A84A" },
    { value: "relatorio", label: "Relatório", group: "preparacao", color: "#D4A84A" },
    { value: "revisar", label: "Revisar", group: "preparacao", color: "#D4A84A" },
    { value: "revisando", label: "Revisando", group: "preparacao", color: "#D4A84A" },
    // Diligências
    { value: "atender", label: "Atender", group: "diligencias", color: "#6A9EC5" },
    { value: "documentos", label: "Documentos", group: "diligencias", color: "#6A9EC5" },
    { value: "testemunhas", label: "Testemunhas", group: "diligencias", color: "#6A9EC5" },
    { value: "investigar", label: "Investigar", group: "diligencias", color: "#6A9EC5" },
    { value: "buscar", label: "Buscar", group: "diligencias", color: "#6A9EC5" },
    { value: "diligenciar", label: "Diligenciar", group: "diligencias", color: "#6A9EC5" },
    { value: "oficiar", label: "Oficiar", group: "diligencias", color: "#6A9EC5" },
    // Saída
    { value: "protocolar", label: "Protocolar", group: "saida", color: "#C48A50" },
    // Acompanhar (monitorar + delegações)
    { value: "monitorar", label: "Monitorar", group: "acompanhar", color: "#9B84B8" },
    { value: "emilly", label: "Emilly", group: "acompanhar", color: "#9B84B8" },
    { value: "amanda", label: "Amanda", group: "acompanhar", color: "#9B84B8" },
    { value: "taissa", label: "Taissa", group: "acompanhar", color: "#9B84B8" },
    // Concluída
    { value: "protocolado", label: "Protocolado", group: "concluida", color: "#5CB87A" },
    { value: "ciencia", label: "Ciência", group: "concluida", color: "#5CB87A" },
    { value: "resolvido", label: "Resolvido", group: "concluida", color: "#5CB87A" },
    { value: "constituiu_advogado", label: "Constituiu advogado", group: "concluida", color: "#5CB87A" },
    { value: "sem_atuacao", label: "Sem atuação", group: "concluida", color: "#5CB87A" },
    // Arquivado
