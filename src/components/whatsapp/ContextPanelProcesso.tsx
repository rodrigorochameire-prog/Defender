...
function CardSkeleton() {
  return (
    <div className="rounded-lg border border-zinc-800 bg-zinc-800/30 p-3 animate-pulse">
      <div className="h-3 w-24 bg-zinc-700 rounded mb-2" />
      <div className="h-4 w-full bg-zinc-700 rounded mb-1" />
      <div className="h-3 w-3/4 bg-zinc-700/60 rounded" />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3 space-y-2">
        {/* Card: Processo Ativo */}
        <div className="rounded-lg border border-zinc-800 bg-zinc-800/20 p-3 border-l-2 border-l-emerald-500">
          <p className="text-[10px] font-medium uppercase tracking-wide text-zinc-500 mb-1">
            Processo Ativo
          </p>
          {processoAtivo ? (
            <>
              <p className="text-xs font-mono text-zinc-100 font-medium truncate">
        ...
        {isLoading ? (
          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-800/20 p-3 border-l-2 border-l-amber-500">
        ...
        {isLoading ? (
          ...
          <div className={cn(
            "rounded-lg border border-zinc-800 bg-zinc-800/20 p-3 border-l-2",
      ...
      {/* Quick actions */}
      <div className="border-t border-zinc-800 px-3 py-2 flex gap-1.5">
        <button className="flex-1 flex items-center justify-center gap-1 rounded-md bg-zinc-800 hover:bg-zinc-700 transition-colors py-1.5 text-[11px] text-zinc-300 font-medium cursor-pointer">
