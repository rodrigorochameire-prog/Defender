...
export const DRIVE_ATRIBUICOES = [
  ...
  },
  {
    ...
    hoverClass: "hover:border-orange-300 dark:hover:border-orange-500/30 hover:bg-orange-50 dark:hover:bg-orange-500/5",
    iconClass: "text-orange-600 dark:text-orange-400",
    activeBorderClass: "border-l-2 border-orange-500",
