  ...
  if (!mounted || isLoading) {
    return (
      <div className="h-14 px-3 flex items-center">
        <div className="h-11 w-11 rounded-2xl bg-gradient-to-br from-muted to-secondary dark:from-muted dark:to-background animate-pulse" />
        {!collapsed && (
          <div className="ml-3 flex-1">
            <div className="h-4 w-28 bg-muted rounded-lg animate-pulse" />
            <div className="h-3 w-20 bg-secondary dark:bg-background rounded-lg animate-pulse mt-1.5" />
          </div>
        )}
      </div>
    );
