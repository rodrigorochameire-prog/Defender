...
export function TabRegistro({
  ...
  return (
    <div className="space-y-3 max-w-5xl mx-auto">
      {/* Header */}
      <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-end gap-1">
            <div className="flex items-center gap-2">
              <span className="text-xs font-semibold text-neutral-600 dark:text-neutral-400">Completude:</span>
            ...
            <div className="w-32 h-1.5 bg-neutral-200 dark:bg-neutral-700 rounded-full overflow-hidden">
              <div
                className="h-full bg-neutral-700 dark:bg-neutral-300 transition-all duration-500"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
        <div className={`p-2.5 rounded-xl border ${
          statusAudiencia === "concluida"
            ...
            : "bg-neutral-50 dark:bg-neutral-900/30 border-neutral-300 dark:border-neutral-700"
        }`}>
        ...
        <div className="p-2.5 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 bg-white dark:bg-neutral-950">
          <div className="flex items-center gap-2 mb-1">
            <Users className="w-4 h-4 text-neutral-500 dark:text-neutral-400" />
            <Label className="text-xs font-semibold text-neutral-700 dark:text-neutral-300">Depoentes</Label>
          </div>
        ...
        <div className="p-2.5 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 bg-white dark:bg-neutral-950">
          <div className="flex items-center gap-2 mb-1">
            ...
            <Label className="text-xs font-semibold text-neutral-700 dark:text-neutral-300">Data/Hora</Label>
          </div>
          <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-100">
      ...
      {/* Resultado */}
      {registro.resultado && (
        <div className="bg-white dark:bg-neutral-950 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-4">
          ...
          <p className="text-sm text-neutral-700 dark:text-neutral-300">{registro.resultado}</p>
        </div>
      )}
      ...
      {registro.depoentes.length > 0 && (
        <div className="bg-white dark:bg-neutral-950 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-4">
          <Label className="text-[10px] uppercase tracking-wider font-semibold text-neutral-400 dark:text-neutral-500 mb-3 block">
            ...
            {registro.depoentes.map((dep) => {
              ...
              return (
                <div key={dep.id} className={`rounded-lg border ${style.border} overflow-hidden`}>
                  <div className={`p-3 border-b border-neutral-200 dark:border-neutral-800 ${style.bg}`}>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="p-3 space-y-3 bg-white dark:bg-neutral-950">
                    {dep.estrategiaInquiricao && (
                      <div>
                        <Label className="text-xs font-semibold text-neutral-600 dark:text-neutral-400 flex items-center gap-1.5 mb-1">
                          <Target className="w-3 h-3" /> Estratégia de Inquirição
                        </Label>
                        <p className="text-xs text-neutral-700 dark:text-neutral-300 leading-relaxed">{dep.estrategiaInquiricao}</p>
                      </div>
                    )}
                    {dep.perguntasDefesa && (
                      <div>
                        ...
                        <p className="text-xs text-neutral-700 dark:text-neutral-300 leading-relaxed">{dep.perguntasDefesa}</p>
                      </div>
                    )}
                    ...
                    {dep.analisePercepcoes && (
                      <div>
                        ...
                        <p className="text-xs text-neutral-700 dark:text-neutral-300 leading-relaxed">{dep.analisePercepcoes}</p>
                      </div>
                    )}
                    <div className="flex items-center gap-3 pt-2 border-t border-neutral-100 dark:border-neutral-800">
                      <div className="flex items-center gap-1.5">
                        <Mail className="w-3 h-3 text-neutral-400" />
                        <span className="text-[10px] text-neutral-600 dark:text-neutral-400">Intimado: {dep.intimado ? "Sim" : "Não"}</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <Check className="w-3 h-3 text-neutral-400" />
                        <span className="text-[10px] text-neutral-600 dark:text-neutral-400">Presente: {dep.presente ? "Sim" : "Não"}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-4">
          ...
          <div className="space-y-2">
            {registro.motivoNaoRealizacao && (
              <div>
                <Label className="text-xs font-semibold text-neutral-700 dark:text-neutral-300">Motivo:</Label>
                <p className="text-sm text-neutral-900 dark:text-neutral-100">{registro.motivoNaoRealizacao}</p>
              </div>
            )}
            {depoentesRedesignacao.length > 0 ? (
              <div>
                <Label className="text-xs font-semibold text-neutral-700 dark:text-neutral-300">Depoentes que motivaram:</Label>
                <div className="flex flex-wrap gap-1 mt-1">
                  {depoentesRedesignacao.map((nome, idx) => (
                    <Badge key={idx} className="bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 text-xs border-neutral-200 dark:border-neutral-700">
                      {nome}
                    </Badge>
                  ))}
                </div>
            ...
            {registro.dataRedesignacao && (
              <div>
                <Label className="text-xs font-semibold text-neutral-700 dark:text-neutral-300">Nova Data:</Label>
      ...
      {(registro.manifestacaoMP || registro.manifestacaoDefesa || registro.decisaoJuiz) && (
        <div className="space-y-2">
          <Label className="text-[10px] uppercase tracking-wider font-semibold text-neutral-400 dark:text-neutral-500">Manifestações e Decisões</Label>
          <div className="grid grid-cols-1 gap-2">
            {registro.manifestacaoMP && (
              <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-3">
                <Label className="text-xs font-semibold mb-1.5 block text-neutral-700 dark:text-neutral-300 flex items-center gap-1.5">
                  <Scale className="w-3.5 h-3.5" /> Ministério Público
                </Label>
                <p className="text-xs text-neutral-700 dark:text-neutral-300 leading-relaxed">{registro.manifestacaoMP}</p>
              </div>
            )}
            {registro.manifestacaoDefesa && (
              <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-3">
                ...
                <p className="text-xs text-neutral-700 dark:text-neutral-300 leading-relaxed">{registro.manifestacaoDefesa}</p>
              </div>
            )}
            {registro.decisaoJuiz && (
              <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-3">
                ...
                <p className="text-xs text-neutral-700 dark:text-neutral-300 leading-relaxed">{registro.decisaoJuiz}</p>
              </div>
            )}
          </div>
        </div>
      ...
      {registro.anotacoesGerais && (
        <div className="bg-white dark:bg-neutral-950 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-4">
          ...
          <p className="text-sm text-neutral-700 dark:text-neutral-300 whitespace-pre-wrap">{registro.anotacoesGerais}</p>
        </div>
      )}
      ...
      {(() => {
        ...
        return camposPendentes.length > 0 ? (
          <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-3">
            <Label className="text-[10px] uppercase tracking-wider font-semibold text-neutral-400 dark:text-neutral-500 mb-2 block flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5">
              {camposPendentes.map((campo, idx) => (
                <button
                  ...
                  className="px-2 py-1.5 rounded-lg border border-neutral-200/80 dark:border-neutral-800/80 bg-white dark:bg-neutral-950 hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors text-left group cursor-pointer"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-neutral-700 dark:text-neutral-300">{campo.label}</span>
                    <ChevronRight className="w-3 h-3 text-neutral-400 dark:text-neutral-600 group-hover:translate-x-0.5 transition-transform" />
                  </div>
                </button>
              ))}
            </div>
