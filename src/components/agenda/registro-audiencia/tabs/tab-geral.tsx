...
const statusOptions: {
  ...
  },
  {
    ...
    label: "Redesignada",
    icon: AlertTriangle,
    activeBg: "bg-neutral-100 dark:bg-neutral-800/50",
    activeText: "text-neutral-800 dark:text-neutral-200",
    activeIcon: "text-neutral-700 dark:text-neutral-300",
  },
  {
    key: "suspensa",
    label: "Suspensa",
    icon: Clock,
    activeBg: "bg-neutral-100 dark:bg-neutral-800/50",
    activeText: "text-neutral-700 dark:text-neutral-300",
    activeIcon: "text-neutral-600 dark:text-neutral-400",
  },
];
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    idx < statusOptions.length - 1 && "border-r border-neutral-200/80 dark:border-neutral-800/80",
                    isActive
                      ? `${s.activeBg} ${s.activeText}`
                      : "bg-white dark:bg-neutral-900 text-neutral-500 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800/50"
                  )}
                >
                  <Icon className={cn("w-3.5 h-3.5 shrink-0", isActive ? s.activeIcon : "text-neutral-400 dark:text-neutral-500")} />
        ...
        <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-3">
          ...
          <div className="flex rounded-lg border border-neutral-200/80 dark:border-neutral-800/80 overflow-hidden">
            <button
              ...
              className={cn(
                "flex-1 px-3 py-2 flex items-center justify-center gap-1.5 text-xs font-semibold transition-all cursor-pointer border-r border-neutral-200/80 dark:border-neutral-800/80",
                registro.assistidoCompareceu
                  ? "bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-400"
                  : "bg-white dark:bg-neutral-900 text-neutral-500 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800/50"
              )}
            >
              <UserCheck className={cn("w-3.5 h-3.5 shrink-0", registro.assistidoCompareceu ? "text-emerald-600 dark:text-emerald-400" : "text-neutral-400")} />
              Presente
            </button>
            <button
              type="button"
            ...
            >
              <UserX className={cn("w-3.5 h-3.5 shrink-0", !registro.assistidoCompareceu ? "text-rose-600 dark:text-rose-400" : "text-neutral-400")} />
              Ausente
            </button>
          </div>
          ...
          {!registro.assistidoCompareceu && (
            <div className="mt-2.5 flex items-center gap-2.5 animate-in fade-in-50 slide-in-from-top-2">
              ...
              <div className="flex rounded-lg border border-neutral-200/80 dark:border-neutral-800/80 overflow-hidden flex-1">
                <button
                  type="button"
                  onClick={() => setDecretoRevelia(true)}
                  className={cn(
                    "flex-1 px-2.5 py-1.5 text-xs font-semibold transition-all cursor-pointer border-r border-neutral-200/80 dark:border-neutral-800/80 flex items-center justify-center gap-1",
                    decretoRevelia === true
        ...
        <div className="space-y-3 animate-in fade-in-50 slide-in-from-top-2">
          ...
          <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-3">
            ...
            <div className="flex flex-wrap gap-1.5 mb-2.5">
              {motivoNaoRealizacaoOptions.map((opt) => {
                ...
                return (
                  ...
                  >
                    <Icon className={cn("w-3.5 h-3.5 shrink-0", isActive ? "text-neutral-600 dark:text-neutral-400" : "text-neutral-400")} />
                    {opt.label}
                  </button>
                );
              })}
            ...
            {registro.motivoNaoRealizacao === "ausencia-testemunha" && (
              <div className="mt-3 space-y-2.5 pt-3 border-t border-neutral-200/80 dark:border-neutral-800/80">
                <p className="text-xs font-semibold text-neutral-700 dark:text-neutral-300">Detalhes sobre a Testemunha</p>
                      ...
                      {registro.depoentes.map((depoente, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            />
                            <span className="text-neutral-700 dark:text-neutral-300">{depoente.nome}</span>
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            idx === 0 && "border-r border-neutral-200/80 dark:border-neutral-800/80",
          ...
          <div className="bg-neutral-50/50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200/80 dark:border-neutral-800/80 p-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                <Label className="text-xs font-semibold mb-1.5 block text-neutral-600 dark:text-neutral-400">Nova Data</Label>
                <Popover open={novaDataPopoverOpen} onOpenChange={setNovaDataPopoverOpen}>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                      className={cn("w-full justify-start text-left font-normal text-sm h-8 bg-white dark:bg-neutral-950 cursor-pointer", !registro.dataRedesignacao && "text-neutral-500 dark:text-neutral-400")}
                    >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 text-sm h-8 border border-neutral-200 dark:border-neutral-800 rounded-lg bg-white dark:bg-neutral-950 focus:outline-none focus:ring-2 focus:ring-neutral-500/20 focus:border-neutral-500"
                />
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        registro.horarioRedesignacao === h
                          ? "border-neutral-500 bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300"
                          : "border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-neutral-500 dark:text-neutral-400 hover:border-neutral-300"
                      )}
                    >
                      {h}
                    </button>
