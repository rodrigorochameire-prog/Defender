...
import {
  ...
  UserPlus, CreditCard, FileSpreadsheet, Landmark, MapPin, Radar, Package
} from "lucide-react";
...
const iconMap: Record<string, React.ElementType> = {
  ...
  ArrowLeftRight, Timer, Newspaper, Rss, Radio, Map, Activity, UserPlus, CreditCard, FileSpreadsheet, Landmark, MapPin, Radar, Package
};
...
function AdminSidebarContent({ children, setSidebarWidth, userName, userEmail, headerExtra }: {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <SidebarHeader className="h-[60px] border-b border-white/[0.06] flex items-center justify-center px-3">
