...
const typeColors: Record<string, string> = {
  ...
  audiencia: "text-blue-500 bg-blue-500/10",
  audiencia_lembrete: "text-blue-500 bg-blue-500/10",
  juri: "text-purple-500 bg-purple-500/10",
  juri_aviso: "text-purple-500 bg-purple-500/10",
  movimentacao: "text-slate-600 bg-slate-500/10",
  atendimento_agendado: "text-teal-500 bg-teal-500/10",
  visita_carceraria: "text-emerald-500 bg-emerald-500/10",
  aviso_geral: "text-sky-500 bg-sky-500/10",
  documento: "text-green-500 bg-green-500/10",
  mensagem: "text-indigo-500 bg-indigo-500/10",
  usuario: "text-slate-500 bg-slate-500/10",
