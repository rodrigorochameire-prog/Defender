...
const typeColors: Record<string, string> = {
  ...
  movimentacao: "text-zinc-500 bg-zinc-500/10",
  atendimento_agendado: "text-teal-500 bg-teal-500/10",
  visita_carceraria: "text-emerald-500 bg-emerald-500/10",
  aviso_geral: "text-zinc-500 bg-zinc-500/10",
  documento: "text-emerald-500 bg-emerald-500/10",
  mensagem: "text-zinc-500 bg-zinc-500/10",
  usuario: "text-zinc-500 bg-zinc-500/10",
    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="h-10 w-10 rounded-full bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700 hover:border-emerald-500/50 dark:hover:border-emerald-500/50 relative transition-all duration-200"
        >
