...
import { db, withTransaction, audiencias, audienciasHistorico, processos, assistidos, testemunhas } from "@/lib/db";
...
import { importarAudiencias, eventoImportSchema } from "@/lib/agenda/importar-audiencias";
...
export const audienciasRouter = router({
  ...
  // Core logic lives in src/lib/agenda/importar-audiencias.ts for reuse.
