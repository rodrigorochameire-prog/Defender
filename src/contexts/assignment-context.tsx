...
export const ASSIGNMENT_CONFIGS: Record<Assignment, AssignmentConfig> = {
  JURI_CAMACARI: {
    ...
    sidebarTextMuted: "hsl(160, 15%, 40%)",
    sidebarTextMutedDark: "hsl(150, 12%, 60%)",
  ...
  EXECUCAO_PENAL: {
    ...
    sidebarTextMuted: "hsl(210, 14%, 40%)",
  ...
  SUBSTITUICAO_CIVEL: {
    ...
    sidebarTextMuted: "hsl(270, 12%, 42%)",
