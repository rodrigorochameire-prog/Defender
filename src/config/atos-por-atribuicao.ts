...
export const ATOS_POR_ATRIBUICAO: Record<string, string[]> = {
  ...
  "Execução Penal": [
    ...
    "Impugnação à rescisão de ANPP",
    "Alteração de condição do SURSIS",
    "Permissão de saída",
    "Saída temporária",
    "Prisão domiciliar",
...
export const ATO_PRIORITY: Record<string, number> = {
  ...
  "Impugnação à rescisão de ANPP": 16,
  "Alteração de condição do SURSIS": 33,
  "Permissão de saída": 37,
  "Saída temporária": 37,
  "Prisão domiciliar": 23,
  "Livramento condicional": 30,
  "Remição de pena": 37,
  "Relaxamento por excesso de prazo": 21,
  // Análises e cumprimentos (gerados pela varredura)
  "Analisar viabilidade de agravo": 17,
  "Acompanhar pedido de revogação": 29,
  "Analisar decisão": 38,
  "Analisar sentença": 38,
  "Analisar acórdão": 38,
  "Cumprir despacho": 39,
  "Cumprir ato ordinatório": 39,
  // Atos intermediários
  ...
  "Ciência de ata de audiência": 86,
  "Ciência de edital": 93,
  "Ciência de mandado": 93,
  "Ciência de petição": 93,
  "Ciência": 95,
  // Outros / genéricos
  "Outro": 98,
  "Outros": 98,
