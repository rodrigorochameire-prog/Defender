...
CREATE TYPE "public"."tipo_crime_radar" AS ENUM('homicidio', 'tentativa_homicidio', 'trafico', 'roubo', 'furto', 'violencia_domestica', 'sexual', 'lesao_corporal', 'porte_arma', 'estelionato', 'outros');--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "not_temas_user_idx" ON "noticias_temas" USING btree ("user_id");