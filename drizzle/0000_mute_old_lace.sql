CREATE TYPE "public"."ausencia_situacao" AS ENUM('solicitada', 'deferida', 'gozada', 'indeferida', 'cancelada');--> statement-breakpoint
CREATE TYPE "public"."ausencia_tipo" AS ENUM('licenca', 'outra_ausencia');--> statement-breakpoint
...
CREATE TYPE "public"."area" AS ENUM('JURI', 'EXECUCAO_PENAL', 'VIOLENCIA_DOMESTICA', 'SUBSTITUICAO', 'CURADORIA', 'FAMILIA', 'CIVEL', 'FAZENDA_PUBLICA', 'CRIMINAL', 'INFANCIA_JUVENTUDE', 'CRIMINAL_2_GRAU');--> statement-breakpoint
CREATE TYPE "public"."atribuicao" AS ENUM('JURI_CAMACARI', 'VVD_CAMACARI', 'EXECUCAO_PENAL', 'SUBSTITUICAO', 'SUBSTITUICAO_CIVEL', 'GRUPO_JURI', 'MUTIRAO_PROTEGE', 'CRIMINAL_CAMACARI', 'CRIMINAL_SIMOES_FILHO', 'CRIMINAL_LAURO_DE_FREITAS', 'CRIMINAL_CANDEIAS', 'CRIMINAL_ITAPARICA', 'CRIMINAL_2_GRAU_SALVADOR');--> statement-breakpoint
...
CREATE TYPE "public"."papel_processo" AS ENUM('REU', 'CORREU', 'VITIMA', 'TESTEMUNHA', 'DENUNCIANTE', 'QUERELANTE', 'ASSISTENTE', 'REQUERIDO', 'EXECUTADO', 'REEDUCANDO');--> statement-breakpoint
...
CREATE TYPE "public"."unidade" AS ENUM('CAMACARI', 'CANDEIAS', 'DIAS_DAVILA', 'SIMOES_FILHO', 'LAURO_DE_FREITAS', 'SALVADOR', 'ITAPARICA');--> statement-breakpoint
...
CREATE TYPE "public"."vf_tipo_evento" AS ENUM('POSSE', 'PROMOCAO', 'REMOCAO', 'TITULARIDADE', 'ACUMULO', 'DESIGNACAO_RELEVANTE', 'CONVOCACAO', 'FERIAS', 'LICENCA', 'AFASTAMENTO', 'COOPERACAO', 'OUTRA_AUSENCIA', 'DIARIA', 'FOLGA', 'TRABALHO_EXTRAORDINARIO', 'SUBSTITUICAO', 'GRATIFICACAO', 'REEMBOLSO', 'SOLICITACAO_ADM');--> statement-breakpoint
...
CREATE TYPE "public"."siga_import_decisao" AS ENUM('nova', 'ja_importada', 'atualizada');--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "audiencias" (
	...
	"registro_audiencia" jsonb,
	"midias" jsonb DEFAULT '[]'::jsonb,
	"ata" jsonb,
	"anotacoes_rapidas" jsonb DEFAULT '[]'::jsonb,
	"resumo_defesa" text,
	"audio_url" text,
	...
	"audio_fonte" varchar(16),
	"transcricao" text,
	"transcricao_resumo" text,
	"transcricao_status" varchar(20),
	"transcricao_idioma" varchar(10) DEFAULT 'pt-BR',
	"google_calendar_event_id" text,
	"gerar_prazo_apos" boolean DEFAULT false,
	"prazo_gerado_id" integer,
	"motivo_nao_realizacao" varchar(40),
	"motivo_detalhe" text,
	"aguardando_nova_data" boolean DEFAULT false NOT NULL,
...
CREATE TABLE IF NOT EXISTS "testemunhas" (
	...
	"observacoes" text,
	"ouvido_em" timestamp,
	"redesignado_para" date,
	"sintese_juizo" text,
	"audio_drive_file_id" varchar(100),
	"certidao_comunicacao" text,
	"depoimento_audio_drive_file_id" varchar(100),
	"depoimento_audio_url" text,
	"depoimento_audio_mime_type" varchar(50),
	"depoimento_audio_duracao" integer,
	"depoimento_transcricao" text,
	"depoimento_segments" jsonb,
...
CREATE TABLE IF NOT EXISTS "evolution_config" (
	...
	"last_sync_contacts_count" integer DEFAULT 0,
	"created_by_id" integer,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "assistidos" (
	...
	"photo_url" text,
	"observacoes" text,
	"historico_penal" jsonb,
	"defensor_id" integer,
	"atribuicao_primaria" "atribuicao" DEFAULT 'SUBSTITUICAO',
	"drive_folder_id" text,
	"sigad_id" varchar(20),
	"sigad_exportado_em" timestamp,
	"solar_exportado_em" timestamp,
	"analysis_status" varchar(20),
	"analysis_data" jsonb,
	"analyzed_at" timestamp,
	"analysis_version" integer DEFAULT 0,
	"origem_cadastro" varchar(20) DEFAULT 'manual',
	"duplicata_sugerida" jsonb,
	"comarca_id" integer DEFAULT 1 NOT NULL,
	"workspace_id" integer,
	"autor_nao_identificado" boolean DEFAULT false NOT NULL,
	"nota_privada" text,
	"deleted_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
...
CREATE TABLE IF NOT EXISTS "demandas" (
	...
	"status" "status_demanda" DEFAULT '5_TRIAGEM',
	...
	"delegacao_work_status" varchar(20),
	"prazo_sugerido" date,
...
CREATE TABLE IF NOT EXISTS "processos" (
	...
	"tipo_patrocinio" varchar(20) DEFAULT 'DEFENSORIA' NOT NULL,
	"advogado_particular" text,
	"fase" varchar(50),
	...
	"drive_folder_id" text,
	"caso_id" integer,
	"tipo_processo" varchar(30) DEFAULT 'AP',
	"is_referencia" boolean DEFAULT false,
	"analysis_status" varchar(20),
	"analysis_data" jsonb,
	"analyzed_at" timestamp,
	"analysis_version" integer DEFAULT 0,
	"pessoas_promovidas_em" timestamp with time zone,
	"delitos_promovidos_em" timestamp with time zone,
	"lugares_promovidos_em" timestamp with time zone,
	"cautelares_promovidas_em" timestamp with time zone,
	"modus_operandi" jsonb,
	"anpp" jsonb,
	"local_do_fato_endereco" text,
	"local_do_fato_lat" numeric(10, 7),
	"local_do_fato_lng" numeric(10, 7),
	"workspace_id" integer,
	"deleted_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	"instancia" "instancia_processo" DEFAULT 'PRIMEIRA',
	"processo_origem_id" integer,
	"defensor_2g_id" integer,
	"defensor_brasilia_id" integer,
	"classe_recursal" "classe_recursal",
	"camara" text,
	"relator" text,
...
CREATE TABLE IF NOT EXISTS "users" (
	...
	"pode_ver_todos_assistidos" boolean DEFAULT true,
	"pode_ver_todos_processos" boolean DEFAULT true,
	"defensores_vinculados" jsonb,
	"areas_principais" jsonb,
	...
	"storage_provider" varchar(20) DEFAULT 'google',
	"onedrive_root_folder_id" varchar(100),
	"drive_folder_id" varchar(100),
	"drive_group_id" integer,
	"sheets_spreadsheet_id" varchar(100),
	"sheets_spreadsheet_url" text,
	"sheets_sync_enabled" boolean DEFAULT false,
	"workspace_id" integer,
	"defensor_ba_id" integer,
	"deleted_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "drive_groups" (
	...
	"label" text NOT NULL,
	"atribuicao_folders" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "personagens_juri" (
	...
	"historico" text,
	"total_sessoes" integer DEFAULT 0,
	"total_condenacoes" integer DEFAULT 0,
	"total_absolvicoes" integer DEFAULT 0,
	"total_desclassificacoes" integer DEFAULT 0,
	"tempo_medio_sustentacao" integer,
	"argumentos_preferidos" jsonb,
	"teses_vulneraveis" jsonb,
...
CREATE TABLE IF NOT EXISTS "sessoes_juri" (
	...
	"pena_aplicada" text,
	"observacoes" text,
	"simulacao_resultado" jsonb,
	"registro_completo" boolean DEFAULT false,
	"juiz_presidente" text,
	"promotor" text,
	"duracao_minutos" integer,
	"local_fato" text,
	"tipo_penal" "tipo_penal_juri",
	"tese_principal" text,
	"reu_primario" boolean,
	"reu_idade" integer,
	"vitima_genero" varchar(20),
	"vitima_idade" integer,
	"usou_algemas" boolean,
	"incidentes_processuais" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "processos_vvd" (
	...
	"fase_procedimento" varchar(40),
	"motivo_ultima_intimacao" varchar(40),
	"prazo_mpu_dias" integer,
	"juiz_decisor" varchar(200),
	"defensor_id" integer,
	"observacoes" text,
	"pje_documento_id" varchar(50),
	...
	"medidas_solicitadas" jsonb,
	"contexto_civel" jsonb,
	"acao_penal_vvd" jsonb,
	"raio_restricao_metros" integer,
	"agressor_residencia_endereco" text,
	"agressor_residencia_lat" numeric(10, 7),
	"agressor_residencia_lng" numeric(10, 7),
	"agressor_trabalho_endereco" text,
	"agressor_trabalho_lat" numeric(10, 7),
	"agressor_trabalho_lng" numeric(10, 7),
	"deleted_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "anotacoes" (
	...
	"metadata" jsonb,
	"conteudo_hash" varchar(16),
	"solar_synced_at" timestamp,
	"solar_fase_id" varchar(50),
	"created_by_id" integer NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
...
CREATE INDEX IF NOT EXISTS "ausencias_defensor_tipo_data_idx" ON "ausencias" USING btree ("defensor_id","tipo","data_inicio");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "analises_cowork_audiencia_id_idx" ON "analises_cowork" USING btree ("audiencia_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "cross_analyses_assistido_idx" ON "cross_analyses" USING btree ("assistido_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "whatsapp_chat_messages_contact_created_idx" ON "whatsapp_chat_messages" USING btree ("contact_id","created_at");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "demandas_import_batch_id_idx" ON "demandas" USING btree ("import_batch_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "processos_analysis_status_idx" ON "processos" USING btree ("analysis_status");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "user_settings_user_id_idx" ON "user_settings" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "delitos_comarca_idx" ON "delitos" USING btree ("comarca_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "documentos_enrichment_status_idx" ON "documentos" USING btree ("enrichment_status");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "drive_doc_sections_pagina_inicio_idx" ON "drive_document_sections" USING btree ("pagina_inicio");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "drive_doc_sections_review_status_idx" ON "drive_document_sections" USING btree ("review_status");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "drive_files_enriched_at_idx" ON "drive_files" USING btree ("enriched_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "drive_files_user_idx" ON "drive_files" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "drive_groups_owner_idx" ON "drive_groups" USING btree ("owner_user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "drive_sync_folders_user_idx" ON "drive_sync_folders" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "speaker_labels_file_idx" ON "speaker_labels" USING btree ("file_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "factual_fav_user_idx" ON "factual_favoritos" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "institutos_comarca_idx" ON "institutos" USING btree ("comarca_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "medidas_socio_reavaliacao_idx" ON "medidas_socioeducativas" USING btree ("data_proxima_reavaliacao");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "subscriptions_vencimento_idx" ON "subscriptions" USING btree ("data_vencimento");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "siga_import_staging_defensor_nsiga_idx" ON "siga_import_staging" USING btree ("defensor_id","n_siga");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "pje_ledger_processo_numero_idx" ON "pje_intimacoes_ledger" USING btree ("processo_numero");