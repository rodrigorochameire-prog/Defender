...
CREATE TYPE "public"."area" AS ENUM('JURI', 'EXECUCAO_PENAL', 'VIOLENCIA_DOMESTICA', 'SUBSTITUICAO', 'CURADORIA', 'FAMILIA', 'CIVEL', 'FAZENDA_PUBLICA', 'CRIMINAL', 'INFANCIA_JUVENTUDE');--> statement-breakpoint
CREATE TYPE "public"."atribuicao" AS ENUM('JURI_CAMACARI', 'VVD_CAMACARI', 'EXECUCAO_PENAL', 'SUBSTITUICAO', 'SUBSTITUICAO_CIVEL', 'GRUPO_JURI', 'CRIMINAL_CAMACARI', 'CRIMINAL_SIMOES_FILHO', 'CRIMINAL_LAURO_DE_FREITAS', 'CRIMINAL_CANDEIAS', 'CRIMINAL_ITAPARICA');--> statement-breakpoint
