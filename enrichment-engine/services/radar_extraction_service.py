...
BAIRROS_CAMACARI = [
    # ── Distrito Camaçari (Sede) ──────────────────────────────────────────────
    "Alto da Bela Vista", "Alto do Cruzeiro", "Alto Cruz",
    "Bairro do Natal", "Bairro dos 46",
    "Caixa d'Água", "Camacari de Dentro", "Camaçari de Dentro",
    "Caminho da Lagoa", "Campo Limpo", "Centro",
    "Dois de Julho", "Estrada do Côco",
    "Fazenda Mamão", "Ficam", "Ficam II",
    "Gardênia",
    "Gleba A", "Gleba B", "Gleba C", "Gleba E", "Gleba H",
    "Gravatá",
    "Inocoop", "Jambeiro", "Jardim Limoeiro", "Jardim Panorama",
    "Km 32", "Lama Preta", "Limoeiro",
    "Loteamento Parque Verde", "Loteamento Santo Amaro",
    "Mangueiral", "Nova Aliança", "Nova Esperança", "Nova Vitória", "Novo Horizonte",
    "Parafuso", "Parque das Mangabas", "Parque Florestal",
    "Parque Satélite", "Parque Verde", "Parque Verde II",
    "Phoc I", "Phoc II", "Phoc III", "Piaçaveira",
    "Polo Industrial", "Pólo Petroquímico",
    "Ponto Certo", "Real Park", "Reserva Camassary",
    "Santo Antônio", "São Bento", "Setor Industrial Urbano",
    "Stela Mares", "Sucuiu", "Triângulo",
    "Verde Horizonte", "Verdes Horizontes",
    "Vila Camaçari", "Vila Rica",
    # ── Distrito Abrantes ─────────────────────────────────────────────────────
    "Abrantes", "Areias",
    "Boa União", "Buri Satuba", "Buris de Abrantes",
    "Canto do Sol", "Catu de Abrantes", "Coqueiro de Abrantes",
    "Jauá",
    "Nova Abrantes",
    "Santo Amaro de Ipitanga",
    "Vila de Abrantes", "Vila Praiana",
    # ── Distrito Monte Gordo ──────────────────────────────────────────────────
    "Arembepe",
    "Barra de Pojuca", "Barra do Jacuípe",
    "Guagirus", "Guarajuba",
    "Imbassaí", "Itacimirim",
    "Monte Gordo",
]
