...
> Relatórios analíticos (dossiês, análises, varreduras) NÃO levam assinatura. São documentos internos de trabalho. Encerram com **Rodapé do Relatório** — ver `padrao-relatorio.md`.
