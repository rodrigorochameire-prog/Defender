...
Antes de montar a lista de arquivos, comparar tamanhos em bytes. Arquivos com o mesmo tamanho são idênticos mesmo com nomes distintos — não listá-los como arquivos separados. Exemplo: dois áudios podem ter nomes diferentes mas ser o mesmo arquivo (confirmado por tamanho idêntico).

---

## Metodologia de Transcrição Recomendada

O processo a seguir resulta em transcrições de alta fidelidade:
...
- [ ] Nomes próprios estão corretos (conferir contra o PDF de transcrição ou a escuta manual)?
